...
TrOCR model(microsoft/trocr-base-printed) as starting point:
Server receives b64 encoded image bytes, OCRManager receives raw image bytes and has to return a list of strings(predictions of transcribed text)