...
DEFAULT_REWARDS_DICT = {
    ...
    # RewardNames.AGENT_COLLIDER: -2,
    # RewardNames.AGENT_COLLIDEE: -1,
    # RewardNames.STATIONARY_PENALTY: 0,
    # RewardNames.GUARD_TRUNCATION: -20,
    # RewardNames.SCOUT_TRUNCATION: 20,
    # RewardNames.GUARD_STEP: -0.10,
    # RewardNames.SCOUT_STEP: 0
}
...
class raw_env(AECEnv[AgentID, ObsType, ActionType]):
    ...
    def _generate_arena(self):
        print("DEBUG: _generate_arena started") # ADD THIS
    ...
    def _capture_scout(self, capturers):
        ...
        print((f"{capturers} have captured the scout"))
