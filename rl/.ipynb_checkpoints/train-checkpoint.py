...
MODEL_SAVE_DIR = os.path.join(SCRIPT_DIR, "models_universal_custom_rewards_v3") 
...
OLD_MODEL_ABSOLUTE_PATH = "/home/jupyter/til-25/rl/rlagent_spencer/models_universal_custom_rewards_v3/universal_agent_best.pth" 

FORCE_EPSILON_START_ON_LOAD = False 
EPSILON_START_CONTINUE = 0.1 # Start with re-exploration for V3 rewards
...
NUM_EPISODES = 75000 # New total target (e.g., if V1 was 20k, this means 40k new eps)
...
def main():
    ...
    csv_log_filename = os.path.join(MODEL_SAVE_DIR, "universal_agent_custom_rewards_log.csv") # Simplified log name
